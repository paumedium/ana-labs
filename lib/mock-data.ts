...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    socials: {
      ...
      whatsapp: "https://wa.me/5491126082642",
    },
  },
];
...
export const brandUsers: Record<string, BrandUser[]> = {
  ...
  DRV: [
    ...
    { email: "info@driven.com.ar", role: "cliente", status: "sin confirmar", invited: "pendiente", lastAccess: "-" },
  ],
};
  ...
  DRV: [
    {
      ...
      status: "para revision",
      format: "Feed 4:5",
      title: "Big Boy uso real",
      headline: "EQUIPATE PARA TODO.",
      subhead: "Te banca en el uso real.",
      copy: "Una pieza base para presentar producto real, respaldo argentino y CTA sin prometer stock/precio.",
      caption: "Compresor Big Boy como producto héroe: ruta, garage y respaldo local. Falta cargar foto real, precio vigente y URL.",
      visualCue: "Compresor protagonista sobre fondo verde oscuro, textura de ruta/garage, sello 2 años garantía y CTA Equipate.",
      palette: "#1F2A24",
      tags: ["Producto", "4x4", "Garantía"],
      pipeline: [
        { title: "Idea", body: "Crear template de producto héroe para Big Boy y línea 4x4." },
        { title: "Ancla en ficha", body: "DIM-03 posicionamiento: calidad real + respaldo argentino. DIM-05 Overlander Pro." },
        { title: "Pendiente", body: "Reemplazar placeholder por foto real, precio SAP y URL de compra." },
      ],
    },
    {
      id: 702,
      ...
      status: "borrador",
      format: "Carrusel",
      title: "Elegí con datos",
      headline: "ELEGÍ CON DATOS.",
      subhead: "Uso, specs y respaldo.",
      copy: "Uso real, especificación clara y garantía validada. Tres datos para comprar mejor.",
      caption: "Carrusel educativo para bajar objeciones sin atacar competencia ni inventar promesas.",
      visualCue: "Tres placas: uso real, detalle técnico, respaldo local; estética beige/verde con producto recortado.",
      palette: "#A07D5D",
      tags: ["Educativo", "Specs", "Objeción"],
      pipeline: [
        { title: "Idea", body: "Bajar objeción '¿aguanta uso real?' con datos simples." },
        { title: "Ancla en ficha", body: "DIM-05 Overlander Pro + Hobbista del Garage." },
        { title: "Pendiente", body: "Definir producto/categoría y specs exactas." },
      ],
    },
    {
      id: 703,
      ...
      format: "Story 9:16",
      title: "Uso en garage",
      headline: "LISTO PARA USAR.",
      subhead: "Probalo en tu taller.",
      copy: "UGC simple: una mano muestra el producto en garage real y remarca robustez sin promesas no validadas.",
      caption: "Para hobbistas del garage: especificación visible, uso real y CTA corto.",
      visualCue: "Celular vertical, mano usando producto en taller, anotaciones sobrias en amarillo industrial.",
      palette: "#F5C518",
      tags: ["UGC", "Garage", "Uso real"],
      pipeline: [
        { title: "Concepto UGC", body: "Convertir el uso real en prueba de robustez." },
        { title: "Ancla en ficha", body: "DIM-05 Hobbista del Garage: de dependiente a autosuficiente." },
        { title: "Pendiente", body: "Cargar producto real y validar specs." },
      ],
    },
  ],
};
  ...
  DRV: [
    {
      ...
      trigger: "Crear primera cover de producto para Big Boy: compresor, ruta, garage y respaldo local.",
      phrases: ["EQUIPATE PARA TODO.", "Te banca en el uso real.", "Listo para la ruta."],
      anchor: "DIM-03 calidad real + DIM-05 Overlander Pro",
      notes: "Funciona como molde editable hasta cargar foto real, precio SAP y URL.",
    },
    {
      id: "D2",
      status: "disponible",
      ...
      trigger: "Atacar la duda '¿aguanta uso real?' con specs, materiales, garantía y contexto.",
      phrases: ["ELEGÍ CON DATOS.", "Uso, specs y respaldo.", "Hecho para usar."],
      anchor: "DIM-05 Overlander Pro + Hobbista del Garage",
      notes: "Ideal para carrusel educativo por producto/categoría.",
    },
    {
      id: "D3",
      status: "disponible",
      title: "Comunidad Driven",
      category: "Comunidad",
      skill: "S12 - tono",
      trigger: "Mostrar que la marca vive en usuarios reales: ruta, campamento, garage, salida y prueba.",
      phrases: ["SUMATE A LA COMUNIDAD.", "Vamos más allá.", "Probado en uso real."],
      anchor: "DIM-12 Explorer + DIM-06 comunidad/respaldo",
      notes: "Usar sin modelos profesionales ni stock genérico.",
    },
  ],
};
  ...
  DRV: [
    {
      ...
      date: "28-may, 00:15",
      status: "pendiente",
      title: "Validar datos comerciales críticos",
      detail: "Cobertura de garantía, devoluciones, plazos por zona, tarjetas de 6 cuotas, vigencia 10% OFF, TyC/Privacidad y Facundo Arana.",
      asset: "8",
    },
    {
      id: 2,
      date: "28-may, 00:15",
      status: "pendiente",
      title: "Subir logos Driven",
      detail: "Faltan logo original, logo white-knockout, logo black-knockout e isotipo si existe.",
      asset: "LOGO",
    },
    {
      id: 3,
      ...
      detail: "Prioridad: Big Boy, Flamate, Red Force, Bidón 15L, Argentine Adventure y Estrella del Sur.",
      asset: "IMG",
    },
    {
      id: 4,
      date: "28-may, 00:15",
      status: "pendiente",
      title: "Importar catálogo/SAP",
      detail: "Sin SKU, precio, stock y URL no se deben publicar piezas comerciales con promesas concretas.",
      asset: "SAP",
    },
  ],
};
...
export const publications: Record<string, Publication[]> = {
  ...
  DRV: [
    { id: 701, date: "2026-06-03", day: 3, time: "10:00", channel: "Instagram", format: "Feed 4:5", status: "borrador", title: "Big Boy uso real", creativeId: 701 },
    { id: 702, date: "2026-06-06", day: 6, time: "12:00", channel: "Instagram", format: "Carrusel", status: "borrador", title: "Elegí con datos", creativeId: 702 },
  ],
};
...
export const auditItems: Record<string, AuditItem[]> = {
  ...
  DRV: [
    { code: "M1", title: "Ficha Driven 12D actualizada", status: "aplicado", category: "Marca", note: "Ya incluye razón social, sede, canales, arquetipo Explorer y buyer personas." },
    { code: "M2", title: "Promesas comerciales pendientes", status: "critico", category: "Marca", note: "Garantía exacta, devoluciones, plazos, tarjetas, vigencia 10% OFF y Facundo Arana siguen pendientes." },
    { code: "C1", title: "Ideas alineadas a outdoor real", status: "aplicado", category: "Contenido", note: "Big Boy, uso real, datos técnicos y Comunidad Driven." },
    { code: "P1", title: "Falta catálogo/SAP", status: "critico", category: "Performance", note: "Sin SKU, precios, stock y URLs no se publican campañas con promesa comercial." },
    { code: "X1", title: "Assets críticos pendientes", status: "pendiente", category: "Conversión", note: "Logo 3 variantes + productos héroe + premios/sponsor." },
  ],
};
